...
<div class="slide_show">
    <div class="imageSlides visible">
        <img class="slideimg" src="{{ asset('images/Slide/01.jpg') }}" alt="slide">
    </div>
    <div class="imageSlides">
        <img class="slideimg" src="{{ asset('images/Slide/02.jpg') }}" alt="slide">
    </div>
    <div class="imageSlides">
        <img class="slideimg" src="{{ asset('images/Slide/03.jpg') }}" alt="slide">
    </div>
    <div class="wow lightSpeedIn text" data-wow-delay="0.3s">
        <h4>{{ t('slider', 'slider_head') }}</h4>
        <p>{{ t('slider', 'slider_head2') }}</p>
        <a href="{{ route('about') }}">{{ t('general', 'read_more') }}</a>
    </div>
                    ...
                    <div class="small_slide">
                        <div class="product-slider-1 owl-carousel">
                            <div class="product-item">
                                <div class="pi-pic">
                                    <img src="{{ asset('images/product/helmet-500x320.png') }}" alt="">
                                </div>
                            </div>
                            <div class="product-item">
                                <div class="pi-pic">
                                    <img src="{{ asset('images/product/hammer-500x320.png') }}" alt="">
                                </div>
                            </div>
                            <div class="product-item">
                                <div class="pi-pic">
                                    <img src="{{ asset('images/product/plaster-500x320.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="image_holder">
                    <img src="{{ asset('storage/' . $category->image) }}" alt="{{ $isArabic ? $category->name_ar : $category->name }}">
                    <p>{{ $isArabic ? $category->name_ar : $category->name }}</p>
                </div>
            </div>
            @endforeach
        </div>
    ...
    <div class="container">
        <div class="product-slider owl-carousel">
            ...
            <div class="product-item">
                ...
                <div class="text">{{ $isArabic ? $product->name_ar : $product->name }}</div>
            </div>
            @endforeach
        </div>
    </div>
...
<div class="main_content">
    <div class="container">
        <div class="holder big wow bounceInLeft" data-wow-delay="0.3s">
            <h4>{{ t('about', 'about_h4') }}</h4>
            <p>{{ t('about', 'about_c4_1') }}</p>
            <p>{{ t('about', 'about_c4_2') }}</p>
            <p>{{ t('about', 'about_c4_3') }}</p>
            <p>{{ t('about', 'about_c4_4') }}</p>
            <div class="row">
                <div class="col-8"></div>
                <div class="col-4">
                    <a href="{{ route('about') }}">{{ t('general', 'read_more') }}</a>
